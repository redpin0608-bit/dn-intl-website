window.I18N_DICT = {
  ko: {
    ...
    hero: {
      ...
      title: "한국 브랜드의 <span class=\"accent\">중국 진출</span>,<br>상하이 현지에서 함께 엽니다",
      lede: "DN INTL.(다은인터내셔널)은 상하이 잉하이 테크놀로지(上海赢海科技)와의 파트너십을 기반으로 시장조사부터 유통망 입점, 라이브커머스, MOU 체결까지 중국 진출의 전 과정을 원스톱으로 지원합니다.",
    ...
    services: {
      ...
      s1: { title: "비즈니스 매칭 & MOU 체결 지원", desc: "상하이 현지 파트너·유통사·바이어와의 매칭부터 MOU 체결까지 계약 전 과정을 지원합니다.", tag1: "파트너 매칭", tag2: "계약 지원" },
      s2: { title: "온라인 유통망 입점", desc: "티몰·징동·핀둬둬 등 이커머스와 위챗채널·도우인·샤오홍슈 등 콘텐츠 커머스 입점을 지원합니다." },
      s3: { title: "라이브커머스 & 테스트 판매", desc: "3천만 팔로워 규모의 인플루언서 네트워크를 활용해 정식 입점 전 소규모 테스트 판매를 진행합니다.", tag1: "KOL 라이브커머스", tag2: "테스트 마케팅" },
    ...
    process: {
      ...
      lede: "막연한 진출이 아닌, 검증된 프로세스로 리스크는 줄이고 성공률은 높입니다.",
      p1: { title: "시장조사", desc: "카테고리·경쟁사·소비자 트렌드 분석" },
      p2: { title: "제품 적합성 검토", desc: "현지 규제·인허가·가격 경쟁력 진단" },
      p3: { title: "리소스 매칭", desc: "유통사·인플루언서·채널 파트너 연결" },
      p4: { title: "MOU 체결 지원", desc: "계약 조건 협의 및 체결 실무 지원" },
      p5: { title: "라이브커머스 테스트", desc: "소규모 실판매로 반응 검증" },
      p6: { title: "유통 채널 투어", desc: "오프라인 대형 유통망 입점 협의" },
      p7: { title: "컴플라이언스 점검", desc: "통관·인증·표시광고 규정 최종 점검" },
      p8: { title: "최종 리포트 & 사후관리", desc: "성과 리포트 제공 및 후속 판매 지원" }
    },
    why: {
      eyebrow: "Why DN INTL.", title: "현지에 직접 거점을 둔<br>실행형 파트너",
      lede: "보고서만 전달하는 컨설팅이 아니라, 상하이 현지 팀이 직접 실행까지 책임집니다.",
      i1: { title: "상하이 현지 파트너 직접 운영", desc: "上海赢海科技(잉하이 테크놀로지)와의 파트너십으로 현지 실행력을 확보했습니다." },
      ...
      panel: { quote: "\"리얼달인 · 리얼샵 · 리얼상품페이지 · 리얼피드백 — 진짜 현지 반응으로 검증한 뒤에 확장합니다.\"", name: "DN INTL. × 上海赢海科技", role: "한중 비즈니스 협력 파트너십" }
    },
    route: {
      kr: { title: "Korea", desc: "DN INTL. 본사<br>한국 브랜드 소싱 & 발굴" },
      mid: "TRADE ROUTE",
      cn: { title: "Shanghai, China", desc: "上海赢海科技 파트너 거점<br>유통·마케팅 현지 실행" }
    },
    partners: {
      eyebrow: "Network", title: "파트너 & 협력 네트워크",
      lede: "현지 실행력을 갖춘 파트너들과 함께 중국 시장 진출을 뒷받침합니다.",
      p1: { desc: "이커머스 운영·라이브커머스·위챗 프라이빗 도메인·오프라인 유통 및 브랜드 현지화를 담당하는 상하이 현지 채널 파트너입니다.", role: "Shanghai Yinghai Technology · 채널 파트너" },
      p2: { desc: "위챗채널·콰이쇼우·샤오홍슈 합산 3,000만+ 팔로워를 보유한 인플루언서·라이브커머스 리소스 네트워크입니다.", role: "MCN · 인플루언서 네트워크" },
    ...
    contact: {
      ...
      phone: { label: "전화 문의" }, email: { label: "이메일 문의" }, office: { label: "거점", value: "대한민국(서울) · 중국(상하이)" }
    },
    form: {
      name: "담당자명", "name.ph": "홍길동", company: "회사명", "company.ph": "회사명을 입력해주세요",
      phone: "연락처", "phone.ph": "010-0000-0000", email: "이메일", "email.ph": "example@email.com",
      interest: "관심 서비스",
    ...
    footer: {
      desc: "다은인터내셔널(DN INTL.)은 상하이 잉하이 테크놀로지와의 파트너십을 기반으로 한국 브랜드의 중국 시장 진출을 지원하는 한중 무역 전문 회사입니다.",
  ...
  en: {
    ...
    hero: {
      ...
      title: "Bringing Korean brands into <span class=\"accent\">China</span>,<br>built with our Shanghai team on the ground",
      lede: "DN INTL. partners with Shanghai Yinghai Technology to run the full China market-entry journey — market research, distribution onboarding, livestream commerce, and MOU execution — as one seamless service.",
    ...
    services: {
      ...
      s1: { title: "Business Matching & MOU Support", desc: "We connect you with vetted Shanghai partners, distributors and buyers, and manage the whole process through MOU signing.", tag1: "Partner matching", tag2: "Contract support" },
      ...
      s3: { title: "Livestream Commerce & Test Sales", desc: "We run small-scale live test sales through a 30M+ follower influencer network before a full rollout." , tag1: "KOL livestream", tag2: "Test marketing"},
    ...
    process: {
      ...
      lede: "Not guesswork — a proven process that lowers risk and raises your odds of success.",
      p1: { title: "Market Research", desc: "Category, competitor and consumer trend analysis" },
      p2: { title: "Product Fit Review", desc: "Local regulation, licensing and price-competitiveness check" },
      p3: { title: "Resource Matching", desc: "Connecting distributors, influencers and channel partners" },
      p4: { title: "MOU Support", desc: "Negotiating terms and handling signing logistics" },
      p5: { title: "Livestream Test", desc: "Validating demand through small-scale live sales" },
      p6: { title: "Retail Channel Tour", desc: "Negotiating offline large-format retail entry" },
      p7: { title: "Compliance Check", desc: "Final review of customs, certification and labeling rules" },
    ...
    why: {
      ...
      lede: "Not a consultancy that just hands you a report — our Shanghai team executes alongside you.",
      i1: { title: "Run directly with our Shanghai partner", desc: "Our partnership with Shanghai Yinghai Technology gives us real local execution power." },
      ...
      panel: { quote: "\"Real influencer, real shop, real product page, real feedback — we scale only after the local market proves it out.\"", name: "DN INTL. × Shanghai Yinghai Tech.", role: "Korea–China business partnership" }
    },
    route: {
      kr: { title: "Korea", desc: "DN INTL. headquarters<br>Korean brand sourcing & scouting" },
      mid: "TRADE ROUTE",
      cn: { title: "Shanghai, China", desc: "Shanghai Yinghai Technology partner base<br>Local distribution & marketing execution" }
    },
    partners: {
      eyebrow: "Network", title: "Partners & Cooperation Network",
      lede: "We back your China entry with partners who bring real local execution.",
      p1: { desc: "Our Shanghai channel partner, handling e-commerce operations, livestream commerce, WeChat private-domain, offline retail and brand localization.", role: "Shanghai Yinghai Technology · Channel Partner" },
      p2: { desc: "An influencer and livestream-commerce resource network with 30M+ combined followers across WeChat Channels, Kuaishou and Xiaohongshu.", role: "MCN · Influencer Network" },
    ...
    contact: {
      ...
      phone: { label: "Phone" }, email: { label: "Email" }, office: { label: "Locations", value: "Korea (Seoul) · China (Shanghai)" }
    },
    form: {
      name: "Contact name", "name.ph": "Jane Doe", company: "Company", "company.ph": "Your company name",
      phone: "Phone", "phone.ph": "+82 10-0000-0000", email: "Email", "email.ph": "you@email.com",
    ...
    footer: {
      desc: "DN INTL. partners with Shanghai Yinghai Technology to help Korean brands enter the Chinese market — a dedicated Korea–China trade company.",
  ...
  zh: {
    ...
    hero: {
      ...
      title: "助力韩国品牌<span class=\"accent\">进入中国</span>，<br>与上海本地团队携手落地",
      lede: "DN INTL.（多恩国际）与上海赢海科技建立合作，提供从市场调研、渠道入驻、直播电商到MOU签约的一站式中国市场进入服务。",
    ...
    services: {
      ...
      s1: { title: "商务对接 & MOU 签约支持", desc: "从对接上海本地合作伙伴、渠道商、买家，到MOU签约，全流程提供支持。", tag1: "伙伴对接", tag2: "签约支持" },
      s2: { title: "线上渠道入驻", desc: "支持天猫、京东、拼多多等电商平台，以及微信视频号、抖音、小红书等内容电商入驻。" },
      s3: { title: "直播电商 & 测试销售", desc: "借助3000万+粉丝的网红网络，在正式入驻前先进行小规模测试销售。", tag1: "KOL直播带货", tag2: "测试营销" },
    ...
    process: {
      ...
      lede: "以经过验证的流程降低风险、提高成功率，而非盲目进入。",
      p1: { title: "市场调研", desc: "品类、竞品、消费者趋势分析" },
      p2: { title: "产品适配审查", desc: "本地法规、许可、价格竞争力诊断" },
      p3: { title: "资源对接", desc: "对接渠道商、网红、合作渠道" },
      p4: { title: "MOU 签约支持", desc: "协商合同条款并支持签约事宜" },
      p5: { title: "直播电商测试", desc: "小规模实销验证市场反应" },
      p6: { title: "渠道考察", desc: "线下大型渠道入驻协商" },
      p7: { title: "合规审查", desc: "通关、认证、标示广告法规终审" },
      p8: { title: "结果报告 & 售后管理", desc: "提供成果报告并支持后续销售" }
    },
    why: {
      eyebrow: "为何选择我们", title: "扎根本地的<br>执行型合作伙伴",
      lede: "不止是提交报告的咨询公司 —— 上海本地团队直接参与执行。",
      i1: { title: "上海本地合作伙伴直接运营", desc: "与上海赢海科技的合作，让我们具备真正的本地执行力。" },
      ...
      panel: { quote: "\"真网红 · 真店铺 · 真商品页 · 真反馈 —— 经过真实本地反馈验证后再进行扩张。\"", name: "DN INTL. × 上海赢海科技", role: "韩中商务合作伙伴关系" }
    },
    route: {
      kr: { title: "韩国", desc: "DN INTL. 总部<br>韩国品牌寻源 & 发掘" },
      mid: "贸易路线",
      cn: { title: "中国上海", desc: "上海赢海科技合作据点<br>本地渠道与营销执行" }
    },
    partners: {
      eyebrow: "合作网络", title: "合作伙伴 & 协作网络",
      lede: "携手具备本地执行力的合作伙伴，共同支持中国市场进入。",
      p1: { desc: "负责电商运营、直播电商、微信私域、线下渠道及品牌本地化的上海本地渠道合作伙伴。", role: "上海赢海科技 · 渠道合作伙伴" },
      p2: { desc: "在微信视频号、快手、小红书合计拥有3000万+粉丝的网红与直播电商资源网络。", role: "MCN · 网红网络" },
    ...
    contact: {
      ...
      phone: { label: "电话咨询" }, email: { label: "邮箱咨询" }, office: { label: "据点", value: "韩国（首尔）· 中国（上海）" }
    },
    form: {
      name: "联系人姓名", "name.ph": "请输入姓名", company: "公司名称", "company.ph": "请输入公司名称",
      phone: "联系电话", "phone.ph": "010-0000-0000", email: "电子邮箱", "email.ph": "example@email.com",
      interest: "感兴趣的服务",
    ...
    footer: {
      desc: "DN INTL.（多恩国际）与上海赢海科技合作，助力韩国品牌进入中国市场，是专业的韩中贸易公司。",
      company: "公司", link: { why: "为何选择我们", partners: "合作网络", process: "进入流程" },
      services: "服务项目", contact: "联系方式", reg: "营业执照号 317-17-01486",
      copyright: "© 2026 DN INTL.（多恩国际）版权所有。", tagline: "GATEWAY TO CHINA MARKET"
    }
  }
};
